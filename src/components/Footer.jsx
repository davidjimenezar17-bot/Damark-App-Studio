    ...
    <footer className="border-t border-white/10 bg-ink px-5 py-10 text-white sm:px-8">
      <div className="mx-auto flex max-w-7xl flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-4">
          <span className="grid h-20 w-32 shrink-0 place-items-center">
            <img src={damarkLogo} alt="" className="h-full w-full object-contain drop-shadow-[0_0_16px_rgba(78,166,58,0.12)]" />
          </span>
          <span>
